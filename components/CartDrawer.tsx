      ...
      {isOpen && (
        <>
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="fixed inset-0 bg-stone-900/40 backdrop-blur-sm z-[210]"
          />
          <motion.div
            initial={{ x: '100%' }}
            animate={{ x: 0 }}
            ...
            className="fixed top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl z-[220] flex flex-col"
          >
            ...
            {cart.length > 0 && (
              <div className="p-4 sm:p-6 bg-stone-50 border-t border-stone-100 space-y-4">
                <div className="flex items-center justify-between">
