...
export const Button: React.FC<CombinedProps> = ({ 
  ...
  const variants = {
    primary: "bg-brand-600 text-white hover:bg-brand-700 shadow-[0_10px_20px_-10px_rgba(219,39,119,0.5)] hover:shadow-[0_20px_30px_-10px_rgba(219,39,119,0.6)] hover:-translate-y-1 border border-transparent",
